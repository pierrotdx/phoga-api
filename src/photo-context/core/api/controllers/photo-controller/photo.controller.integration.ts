...
describe(`${PhotoController.name}`, () => {
  ...
  describe("getMetadata", () => {
    beforeEach(() => {
      const entryPoint = entryPoints.get(PhotoEntryPointId.GetPhotoMetadata);
  ...
  describe("getImage", () => {
    ...
    beforeEach(() => {
      ...
      const entryPoint = entryPoints.get(PhotoEntryPointId.GetPhotoImage);
      const path = entryPoint.getFullPathRaw();
  ...
  describe("search", () => {
    ...
    const entryPoint = entryPoints.get(PhotoEntryPointId.SearchPhoto);
    const path = entryPoint.getFullPathRaw();
